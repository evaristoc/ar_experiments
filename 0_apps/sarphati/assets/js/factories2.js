    ...
    (function(){
     //constructor parameters
      ...
      var FactoryObj = function(markerRoot){
         ...
         this._textureLoad = this._textureLoader.load('./assets/grph/PUSHILIN_factory.png');
         this._mtlLoader = new THREE.MTLLoader();
         this._objLoader = new THREE.OBJLoader();
         this._mtlLoader.setPath( 'assets/data/models/' );
         this._objLoader.setPath( 'assets/data/models/' );
       ...
       //scene.add(scene2);
        ...
        function setup() {
            ...
            arToolkitContext = new THREEx.ArToolkitContext({
                cameraParametersUrl: '../../arJS/arjs-resources/data/camera_para.dat',
                detectionMode: 'mono'
            });
            ...
            let markerControls = new THREEx.ArMarkerControls(arToolkitContext, markerRoot, {
                type: 'pattern', patternUrl: "../../arJS/arjs-resources/data/hiro.patt",
            })
        };
