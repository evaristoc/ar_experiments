...
var Butterfly = function () {
    ...
    _createClass(Butterfly, [
            ...
            {
             key: 'wingflappingTween',
             value: function wingflappingTween(){
...
var Chimney = function(){
        function Chimney(options){
            _classCallCheck(this, Chimney);
            var defaults = {
                _textureLoader : new THREE.TextureLoader(),
                _textureLoad : this._textureLoader.load('./assets/PUSHILIN_factory.png'),
                _mtlLoader : new THREE.MTLLoader(),
                _objLoader : new THREE.OBJLoader(),
                _url : 'PUSHILIN_factory',
                to : {
                        x: 0.0,
                        y: -.5,
                        z: -1.0
        ...
        _createClass(Scene,
                     [{
                        ...
                        value: function init(){
                            ...
                            renderer.setClearAlpha(this.alphaval);
                    ...
                    {
                      key:'changeBackgroundTween',
                      value: function changeBackgroundTween(){
                        var scene = this.scene;
                        var duration = 9000;
                        var alphaval = this.alphaval;
                        console.log(alphaval);
                        var tween = new TWEEN
                                        .Tween(this)
                                        .to({alphaval:.8}, duration)
                                        .easing(TWEEN.Easing.Cubic.In)
                                        .onComplete(function(obj){
                                            console.log(obj, alphaval)
                                        })
                                        .start();
                      }
                    },
                    ...
                    },
                    {
                      ...
                      value: function update() {
                        ...
                        //console.error(zelf);
                        statsGlobal.begin();
                        compatibility.requestAnimationFrame(update.bind(this));
                        TWEEN.update();
                        for (var i = 0; i < this.butterflies.length; i++) {
                          this.butterflies[i].move();
                        };
                        this.renderer.setClearAlpha(this.alphaval);
                        this.render();
                        statsGlobal.end();
                      }
                    },
